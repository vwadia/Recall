...
% one per trial
tonePeriodBeginTimes = RecallData.eventsMS(find(RecallData.eventsMS(:, 2) == TONE_PERIOD_BEGIN), 1);
...
% P84 Sess 1
elseif isequal(paths.sessPath, 'ReScreenRecall_Session_1_20230406')
    
    taskStruct = load([paths.basePath filesep paths.taskPath filesep paths.patientPath...
        filesep paths.sessPath filesep 'P84CS_Recall_1_Sub_.mat']);
%     P84CS_Recall_1_Recall_2023-04-06_14-41-07
    ...
    stimuli = {'Shrimp', 'Laptop', 'Mirror', 'Scorpion', 'Legos', 'Flag', 'Bell', 'Medal'}; % stimuli to be recalled
    
    
    % P84 Sess 1
elseif isequal(paths.sessPath, 'ReScreenRecall_Session_2_20230408')
    
    taskStruct = load([paths.basePath filesep paths.taskPath filesep paths.patientPath...
        filesep paths.sessPath filesep 'P84CS_ReScreenRecall_2_Sub_.mat']);
%     P84CS_Recall_1_Recall_2023-04-06_14-41-07
    ...
    stimuli = {'Panda', 'Girl', 'Young Man', 'Lemons', 'Chair', 'Trombone', 'Droplets', 'Bulldozer'}; % stimuli to be recalled

    % P85 Sess 1
elseif isequal(paths.sessPath, 'ReScreenRecall_Session_1_20230424')
    
    taskStruct = load([paths.basePath filesep paths.taskPath filesep paths.patientPath...
        filesep paths.sessPath filesep 'P85CS_Recall_1_Sub_.mat']);
    ...
    stimuli = {'Cat', 'Chicken', 'Man in suit', 'Girl', 'Boy', 'Umbrella', 'Clouds', 'Stroller'}; % stimuli to be recalled
end
...
RecallData.tonePeriodBeginTimes = tonePeriodBeginTimes;
