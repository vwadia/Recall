...
%         fn = 'ppc_LFFACell_LALFP_sigRamp_ScreeningImagination_Cell_combined';
    ...
    elseif strcmp(scale, 'ppc_log')
        datPath = [diskPath filesep task filesep scale filesep 'ReactivatedCells'];
...
%         load([datPath filesep 'ppc_RFFACell_RHLFP_sigRamp_ScreeningImagination_Cell']); Side = 'RFFA';
%         load([datPath filesep 'ppc_LFFACell_LHLFP_sigRamp_ScreeningImagination_Cell']); Side = 'LFFA';
...
%         load([datPath filesep 'ppc_RFFACell_RHLFP_sigRamp_ScreeningImagination_Cell']); Side = 'RFFA';
%         load([datPath filesep 'ppc_LFFACell_LHLFP_sigRamp_ScreeningImagination_Cell']); Side = 'LFFA';
%         load([datPath filesep 'ppc_RFFACell_RALFP_sigRamp_ScreeningImagination_Cell']); Side = 'RFFA';
%         load([datPath filesep 'ppc_LFFACell_LALFP_sigRamp_ScreeningImagination_Cell']); Side = 'LFFA';
%         load([datPath filesep 'ppc_RFFACell_RACLFP_sigRamp_ScreeningImagination_Cell']); Side = 'RFFA';
%         load([datPath filesep 'ppc_LFFACell_LACLFP_sigRamp_ScreeningImagination_Cell']); Side = 'LFFA';
%         load([datPath filesep 'ppc_RFFACell_RSMALFP_sigRamp_ScreeningImagination_Cell']); Side = 'RFFA';
%         load([datPath filesep 'ppc_LFFACell_LSMALFP_sigRamp_ScreeningImagination_Cell']); Side = 'LFFA';
%         load([datPath filesep 'ppc_RFFACell_ROFLFP_sigRamp_ScreeningImagination_Cell']); Side = 'RFFA';
%         load([datPath filesep 'ppc_LFFACell_LOFLFP_sigRamp_ScreeningImagination_Cell']); Side = 'LFFA';
...
for s = 1:length(ppc_Sc)
    if ~isempty(ppc_Sc{s}) && ~isempty(ppc_Im{s})
        ...
        if size(ppc_Im{s}, 1) == 1 && size(ppc_Im{s}, 2) == 1
...
%     xlim([params.low_freq 40])
    ...
    filename = [datPath filesep [params.cellArea 'Cell_' params.lfpArea '_micro-lfp_wPVals_' type]];
